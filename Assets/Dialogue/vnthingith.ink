...
=== main === 
"Ugh I am so nervous." Said MC. "It's my first date with this girl I met the other day in the park, she looked so beautiful under the sun." MC looks at the presents he bought. "Let me prepare the gifts I could give her. 
...
*[Graphics Card!]
    "I have a ZOTAC Gaming GeForce RTX 4090 AMP Extreme AIRO 24GB GDDR6X 384-bit 21 Gbps PCIE 4.0 Graphics Card, IceStorm 3.0 Advanced Cooling, Spectra 2.0 RGB Lighting, ZT-D40900B-10P. I managed to win it off a giveaway that was hosted by some guy I watch on youtube." ->Gifts
* -> main2
...
"Hmm, do I put some body spray on?" 
  ...
  He looks around one last time. "I have done pretty much all I wanted to do to get ready. Let's get going." And with that, our MC heads out to meet his date. 
    ...
    === BeginDate === 
    Our MC arrvies at the date spot. A beautiful //describe scenary
    ...
    "Mhm." The girl replies gleefully, and they make their way to the coffees shop. //wherever the date is
        ...
        * I play video games.
            ...
            **"Yeah"
            "What's your favortie video game?" 
                ...
                ***Overwatch
                ~ game = "Overwatch"
                ---"Omg I am actually very into {game} as well! I am glad we have something in common." 
    ...
    *Graphics card
        ...
        ===FlowerRoute===
        The mc thinks hard for a bit, and then pulls out the flowers he was safely storing in his bag. "This is for you. Someone as pretty as you deserves pretty things." MC hanfs the flower to the girl with a smirk. He thinks he is the rizzler after a line like that. 
        "Oh thank you. It definitely is pretty." She replies, not amused. The day keeps going on without much happening, and eventually time passes til it's night time. MC is walking the girl home.
        ...
        *"No problem. Stay safe." 
        ...
        ===RingRoute===
        The mc thinks hard for a bit, and then pulls out the ring he was safely storing in his bag. "I have something for you," MC shows the ring to the girl. "Here. This isn't an engagement ring by any means. I just an expensive and amazing ring suits someone like you." 
        ...
        ===Movies==
        "I am so happy right now. Where do you want to go?" The girls asks. "I kinda wanna watch a movie"
        ...
        *"Let's go to shopping."
        ...
        -They both make it to the movies happily, talking about random things. After getting their tickets to the front row seats, they start the movie. After finishing the movie...
    ...
    "Hey, I think I need to use the bathroom. Can you wait a bit for me here?" 
        ...
        *Sure, take your time" 
        ...
        In a computer store, a girl disguised by a hat and a mask can be seen strotting to the store cashier. "This is an expensive ring. Can I trade this in for a pc? Better give it to me now." 
        ...
        *"I am glad you had a great time. Can't wait to see you again!" 
        ...
        "I am so lucky to be able to call you my husband. I have been waiting for this day forever." Says the girl. 
